  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-elevated transition-smooth hover:scale-110 active:scale-95"
